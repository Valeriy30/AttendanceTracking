...
namespace AttendanceTracking.DB
{
    ...
    public partial class AttendanceTrackingEntities1 : DbContext
    {
        public AttendanceTrackingEntities1()
            : base("name=AttendanceTrackingEntities1")
        {
        }
        ...
        public virtual DbSet<RoleSpecialist> RoleSpecialist { get; set; }
        public virtual DbSet<Section> Section { get; set; }
        public virtual DbSet<Shedule> Shedule { get; set; }
        public virtual DbSet<Specialist> Specialist { get; set; }
        public virtual DbSet<SpecialistGroup> SpecialistGroup { get; set; }
        public virtual DbSet<Student> Student { get; set; }
        public virtual DbSet<StudentParents> StudentParents { get; set; }
        public virtual DbSet<StudentShedule> StudentShedule { get; set; }
        public virtual DbSet<sysdiagrams> sysdiagrams { get; set; }
        public virtual DbSet<Type> Type { get; set; }
        public virtual DbSet<infoSpecialist> infoSpecialist { get; set; }
